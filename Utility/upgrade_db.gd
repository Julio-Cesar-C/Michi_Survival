...
const UPGRADES = {
	"icespear1": {
		...
		"details": "Uma lança de gelo é atirada em inimigos aleatorios",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"icespear2": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Lança de Gelo",
		"details": "Uma Lança de Gelo adicional é lançada",
		"level": "Level: 2",
	...
	"icespear3": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Lança de Gelo",
		"details": "Lança de Gelos ganha perfuração 1 e + 3 dano",
		"level": "Level: 3",
	...
	"icespear4": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Lança de Gelo",
		"details": " 2 Lanças de Gelos são adicionadas",
		"level": "Level: 4",
	...
	"javelin1": {
		...
		"displayname": "Javelin",
		"details": "Javelin magico te seguira e atacara os inimigos",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"javelin2": {
		"icon": WEAPON_PATH + "javelin_3_new_attack.png",
		"displayname": "Javelin",
		"details": "Javelin fará um ataque adicional",
		"level": "Level: 2",
	...
	"javelin3": {
		"icon": WEAPON_PATH + "javelin_3_new_attack.png",
		"displayname": "Javelin",
		"details": "Javelin fará mais um ataque adicional",
		"level": "Level: 3",
	...
	"javelin4": {
		"icon": WEAPON_PATH + "javelin_3_new_attack.png",
		"displayname": "Javelin",
		"details": "The javelin dará + 5 dano por ataque e causara +20% de empurrão",
		"level": "Level: 4",
	...
	"tornado1": {
		...
		"displayname": "Tornado",
		"details": "Um tornado é criado e atacará na direção da visao de Michi",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"tornado2": {
		"icon": WEAPON_PATH + "tornado.png",
		"displayname": "Tornado",
		"details": "Um tornado adicional será lançado",
		"level": "Level: 2",
	...
	"tornado3": {
		"icon": WEAPON_PATH + "tornado.png",
		"displayname": "Tornado",
		"details": "O cooldown do Tornado é reduzido em 0.5 segundo",
		"level": "Level: 3",
	...
	"tornado4": {
		"icon": WEAPON_PATH + "tornado.png",
		"displayname": "Tornado",
		"details": "Um tornado adicional é criado e o empurrão é aumentado em 25%",
		"level": "Level: 4",
